...
public class Enternainfragment extends Fragment {

    String apikey = "751da5da5ba84a3bbf3fa8d246f41612";
    private RecyclerView entertainRecyc;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.enternainfragment,null);

        entertainRecyc=v.findViewById(R.id.entertainRecyclerV);
        entertainRecyc.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new MainAdapter(getContext(),mylist);
        entertainRecyc.setAdapter(adapter);

...
public class Healthfragment extends Fragment {
    ...
    private RecyclerView healthRecyc;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        healthRecyc=v.findViewById(R.id.healthRecyclerV);

        healthRecyc.setLayoutManager(new LinearLayoutManager(getContext()));
        adapter=new MainAdapter(getContext(),mylist);
        healthRecyc.setAdapter(adapter);
